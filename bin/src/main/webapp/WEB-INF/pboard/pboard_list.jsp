...
<link rel="stylesheet" type="text/css"
	href="/css/pboard/pboard_list.css" />
...
<body>
	...
	<div id="pboard-list">
		...
		<form id="search-bar" name="search-bar-form" action="get">
			...
			<div onclick="location.href='/pboard/write'" id="write-btn">
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td class="text-left"><a href="/pboard/read">6월 모의고사 2023-06-16 모의고사
					...
					<tr>
						...
						<td class="text-left"><a href="/pboard/read">asdasd</a></td>
						<td>
							<h5>홍길동</h5>
						</td>
						<td>
					...
					<tr>
						...
						<td class="text-left"><a href="/pboard/read">123awd </a></td>
						<td>
							<h5>홍길동</h5>
						</td>
						<td>
					...
					<tr>
						...
						<td class="text-left"><a href="/pboard/read">12423634745 </a></td>
						<td>
							<h5>홍길동</h5>
						</td>
						<td>
